            ...
            <>
              <button
                className={classNames(
                  "bg-white text-black uppercase px-4 py-2 ml-4 text-sm font-bold transition ease-in-out duration-300 hover:bg-[#FE4C2F] hover:text-white min-w-[125px]",
                  { hidden: approve }
                )}
      ...
      <div className="mt-2">
        ...
        <div className="w-full flex items-center justify-between">
          ...
          {isLoading && Withdraw ? (
            ...
            <button
              className="bg-white text-black uppercase px-4 py-2 ml-4 text-sm font-bold transition ease-in-out duration-300 hover:bg-[#FE4C2F] hover:text-white min-w-[125px]"
